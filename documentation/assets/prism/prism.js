            ...
            for (var t = 0, a = e.length; t < a; t++) {
              ...
              if ('code' === i.type) {
                ...
                if (
                  ...
                  var l =
                    'language-' + r.content.trim().split(/\s+/)[0].toLowerCase()
                  o.alias
...
!(function () {
  if (
    ...
    var i =
      ...
      t =
        /^#?(?=(?:[\da-f]{1,2}){3,4}$)([\da-f][\da-f]?)([\da-f][\da-f]?)([\da-f][\da-f]?)([\da-f][\da-f]?)?$/i,
      d = [
        function (n) {
          var e = t.exec(n)
          if (e) {
            ...
            return (
              ...
              e
                ...
                .join(',') +
              ',' +
              (void 0 === e[4] ? '1' : (parseInt(e[4], 16) * o).toFixed(3)) +
              ')'
            )
          }
        },
    ...
    Prism.hooks.add('wrap', function (n) {
      if ('color' === n.type || 'hexcode' === n.type) {
        for (
          var e, o = n.content, t = o.split(i).join(''), r = 0, a = d.length;
          r < a && !e;
          r++
        )
          e = d[r](t)
        if (!e) return
        var f =
          '<span class="inline-color" style="background-color:' +
          e +
          ';"></span>'
        n.content = f + o
      }
