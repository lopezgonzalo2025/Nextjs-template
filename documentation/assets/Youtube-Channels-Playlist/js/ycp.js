...
$.fn.ycp = function (j) {
  ...
  $(this).each(function (i, a) {
    const b =
      $(this).attr('id') != null && $(this).attr('id') != undefined
        ? `#${$(this).attr('id')}`
        : `.${$(this).attr('class')}`
    const title =
      $(this).data('ycp_title') == undefined
        ? 'YCP.js'
        : $(this).data('ycp_title')
  ...
  function ycp_list(h, f, g, k, l) {
    $.ajax({
      ...
      d +=
        '<span class="tombol vid-next" title="Next videos">Next</span><span class="about" title="ycp.js"><a href="https://github.com/bachors/jQuery-Youtube-Channels-Playlist" target="_BLANK">♥</a></span></div><div class="handap">'
      $.each(c.items, (i, a) => {
      ...
      if (c.prevPageToken == null || c.prevPageToken == undefined) {
        const e = $(`${l} .ycp div#ycp_youtube_channels${k} div.play`).attr(
          'data-vvv'
        )
        const imag = $(`${l} .ycp div#ycp_youtube_channels${k} div.play`).attr(
          'data-img'
        )
        if (j.autoplay == false) {
          $(`${l} .ycp div.ycp_vid_play:eq(${k})`).html('<a href="#"></a>')
          $(`${l} .ycp div.ycp_vid_play:eq(${k})`).css(
            'background',
            `url(${imag}) no-repeat`
          )
          $(`${l} .ycp div.ycp_vid_play:eq(${k})`).css(
          ...
          $(`${l} .ycp div.ycp_vid_play:eq(${k})`).html(
            `<iframe src="//www.youtube.com/embed/${e}?rel=${
              j.related ? 1 : 0
            }&amp;autoplay=1" allowfullscreen="" frameborder="0" class="bingkay"></iframe>`
          )
        }
        $(`${l} .ycp div#ycp_youtube_channels${k} div`).removeClass(
          'vid-active'
        )
        $(`${l} .ycp div#ycp_youtube_channels${k} div.play:eq(0)`).addClass(
          'vid-active'
        )
      } else {
      ...
      $(`${l} .ycp div#ycp_youtube_channels${k} div.play`).each(function () {
        $(this).click(function () {
          ...
          if (j.autoplay == false) {
            ...
            $(`${l} .ycp div.ycp_vid_play:eq(${k})`).html(
              `<iframe src="//www.youtube.com/embed/${a}?rel=${
                j.related ? 1 : 0
              }&amp;autoplay=1" allowfullscreen="" frameborder="0" class="bingkay"></iframe>`
            )
          }
      ...
      $(`${l} .ycp div.ycp_vid_play:eq(${k})`).click(function () {
        const a = $(
          `${l} .ycp div#ycp_youtube_channels${k} div.play.vid-active`
        ).attr('data-vvv')
        $(this).html(
          `<iframe src="//www.youtube.com/embed/${a}?rel=${
            j.related ? 1 : 0
  ...
  function ycp_part(c, i, d, e) {
    $.ajax({
      ...
      $(`${e} .ycp div#ycp_youtube_channels${d} span.tm${i}`).html(
        `${menit}:${detik}`
      )
      $(`${e} .ycp div#ycp_youtube_channels${d} span.by${i}`).html(
        `by ${a.items[0].snippet.channelTitle}`
      )
      $(`${e} .ycp div#ycp_youtube_channels${d} span.views${i}`).html(
        `${addCommas(a.items[0].statistics.viewCount)} views`
      )
      $(`${e} .ycp div#ycp_youtube_channels${d} span.date${i}`).html(
