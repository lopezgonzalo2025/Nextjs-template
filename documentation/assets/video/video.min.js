  ...
  })(
    {
                    ...
                    return (
                      ...
                      'Player' === b &&
                        ...
                        !(function () {
                          ...
                          if (
                            c.players &&
                            Object.keys(c.players).length > 0 &&
                            Object.keys(c.players)
                              .map(function (a) {
                                return c.players[a]
                              })
                              .every(Boolean)
      ...
      50: [
        function (a, b, c) {
          ...
          var i = a(81),
            ...
            q = (function (a) {
              ...
              return (
                ...
                (b.prototype.buildCSSClass = function () {
                  return (
                    o + ' vjs-hidden ' + a.prototype.buildCSSClass.call(this)
                  )
                }),
                (b.prototype.handleKeyPress = function (a) {
          ...
          ;(q.prototype.options_ = { temporary: !0 }),
                    ...
                    !(function () {
                      ...
                      Object.getOwnPropertyNames(a).forEach(function (b) {
                        'function' == typeof this[b]
                          ? this[b](a[b])
                          : z['default'].error('Unable to find plugin:', b)
                      }, j)
                    })(),
      ...
      56: [
        function (a, b, c) {
          ...
          'complete' === j['default'].readyState
            ? (m = !0)
            : h.one(l['default'], 'load', function () {
                m = !0
              })
          var p = function () {
            return m
                ...
                return (
                  ...
                  (b.prototype.createEl = function () {
                    ...
                    var d = a.techId,
                      ...
                      g = (0, x.assign)(
                        { id: d, name: d, class: 'vjs-tech' },
                        a.attributes
                      )
                    return (
                      (this.el_ = b.embed(a.swf, e, f, g)),
                      (this.el_.tech = this),
                      this.el_
                    )
                  }),
          ...
          ;(z.isSupported = function () {
            ...
            (z.embed = function (a, b, c, d) {
              var e = z.getEmbedCode(a, b, c, d),
                f = n.createEl('div', { innerHTML: e }).childNodes[0]
              return f
            }),
      ...
      60: [
        function (a, b, c) {
            ...
            K = (function (a) {
              function b(c, d) {
                ...
                return (
                  ...
                  e.featuresNativeTextTracks &&
                    (i && w['default'].warn((0, y['default'])(k)),
                    (e.handleTextTrackChange_ = u.bind(
                      e,
                      e.handleTextTrackChange
                    )),
                    (e.handleTextTrackAdd_ = u.bind(e, e.handleTextTrackAdd)),
                    (e.handleTextTrackRemove_ = u.bind(
                      e,
                      e.handleTextTrackRemove
                    )),
                    e.proxyNativeTextTracks_()),
                  (A.TOUCH_ENABLED || A.IS_IPHONE || A.IS_NATIVE_ANDROID) &&
              ...
              return (
                ...
                (b.prototype.createEl = function () {
                  ...
                  if (!a || this.movingMediaElementInDOM === !1) {
                    if (a) {
                      ...
                      var d =
                          this.options_.tag &&
                          q.getElAttributes(this.options_.tag),
                        e = (0, H['default'])({}, d)
                      ;(A.TOUCH_ENABLED &&
                ...
                (b.prototype.handleLateInit_ = function (a) {
                  ...
                  if (0 !== a.networkState && 3 !== a.networkState) {
                    if (0 === a.readyState) {
                      ...
                      if (
                        'object' ===
                        ('undefined' == typeof c ? 'undefined' : j(c))
                      )
                        return c.v
                    }
                    var d = ['loadstart']
                ...
                (b.prototype.duration = function () {
                  ...
                  if (
                    ...
                    if (
                      'object' ===
                      ('undefined' == typeof b ? 'undefined' : j(b))
                    )
                      return b.v
                  }
          ...
          ;(L.kind = 'captions'),
            ...
            (K.prototype.featuresNativeTextTracks =
              K.supportsNativeTextTracks()),
            (K.prototype.featuresNativeVideoTracks =
              K.supportsNativeVideoTracks()),
      ...
      62: [
        function (a, b, c) {
            ...
            L = (function (a) {
              function b() {
                ...
                return (
                  ...
                  (e.textTracks_ = c.textTracks),
                  (e.videoTracks_ = c.videoTracks),
                  (e.audioTracks_ = c.audioTracks),
                  ...
                  ['Text', 'Audio', 'Video'].forEach(function (a) {
                    c['native' + a + 'Tracks'] === !1 &&
                      (e['featuresNative' + a + 'Tracks'] = !1)
                  }),
                  c.nativeCaptions === !1 && (e.featuresNativeTextTracks = !1),
          ...
          L.prototype.textTracks_,
            ...
            k['default'].registerComponent('Tech', L),
            k['default'].registerComponent('MediaTechController', L),
      ...
      66: [
        function (a, b, c) {
          ...
          ;(u.prototype.allowedEvents_ = { load: 'load' }),
            (u.NONE = q),
            (u.LOADING = r),
            (u.LOADED = s),
            (u.ERROR = t),
                      ...
                      if (f) {
                        ...
                        b.fontFamily &&
                          ...
                          ('small-caps' === b.fontFamily
                            ...
                            : (g.firstChild.style.fontFamily = s[b.fontFamily]))
                      }
                    }
                  }
                }),
                ...
                if (this.options_.persistTextTrackSettings) {
                  ...
                  try {
                    Object.keys(a).length
                      ? m['default'].localStorage.setItem(w, JSON.stringify(a))
                      : m['default'].localStorage.removeItem(w)
                  } catch (b) {
                    v['default'].warn(b)
                  }
                }
          ...
          var i = a(67),
            ...
            C = (function (a) {
              function b() {
                ...
                return (
                  'disabled' !== i && n.tech_.on('timeupdate', s),
                  ...
                  Object.defineProperty(n, 'mode', {
                    ...
                    set: function (a) {
                      m.TextTrackMode[a] &&
                        ((i = a),
                        'showing' === i && this.tech_.on('timeupdate', s),
      ...
      78: [
        function (a, b, c) {
          ...
          var e = a(94),
            ...
            h = d(g),
            i =
              (h['default'].navigator && h['default'].navigator.userAgent) ||
              '',
            ...
            r =
              ((c.IS_OLD_ANDROID = p && /webkit/i.test(i) && q < 2.3),
              (c.IS_NATIVE_ANDROID = p && q < 5 && k < 537),
              (c.IS_FIREFOX = /Firefox/i.test(i)),
              (c.IS_EDGE = /Edge/i.test(i))),
            s = (c.IS_CHROME = !r && /Chrome/i.test(i)),
            t =
              ((c.IS_IE8 = /MSIE\s8\.0/.test(i)),
              (c.IE_VERSION = (function (a) {
                return a && parseFloat(a[1])
              })(/MSIE\s(\d+)\.\d/.exec(i))),
              (c.IS_SAFARI = /Safari/i.test(i) && !s && !p && !r))
          ;(c.IS_ANY_SAFARI = t || o),
            (c.TOUCH_ENABLED = !!(
            ...
            (c.BACKGROUND_SIZE_SUPPORTED =
              'backgroundSize' in f['default'].createElement('video').style)
        },
        { 94: 94, 95: 95 }
      ],
      79: [
        ...
        function (a, b, c) {
            ...
            return (
              Object.getOwnPropertyNames(b).forEach(function (a) {
                ...
                a.indexOf('aria-') !== -1 || 'role' === a || 'type' === a
                  ? (S['default'].warn((0, U['default'])(K, a, c)),
                    e.setAttribute(a, c))
                  : 'textContent' === a
                  ? n(e, c)
                  : (e[a] = c)
          ...
          function t(a, b) {
            return (
              a.classList
                ? a.classList.add(b)
                : s(a, b) || (a.className = (a.className + ' ' + b).trim()),
              a
            )
          }
          function u(a, b) {
          ...
          ;(c.isEl = j),
            ...
            (c.setAttribute = z),
            (c.removeAttribute = A),
            (c.blockTextSelection = B),
            (c.unblockTextSelection = C),
            (c.findElPosition = D),
            (c.getPointerPosition = E),
            (c.isTextNode = F),
            (c.emptyEl = G),
            (c.normalizeContent = H),
            (c.appendContent = I),
            (c.insertContent = J)
          var L = a(94),
            M = e(L),
                ...
                !(function () {
                  ...
                  for (var e in d)
                    'layerX' !== e &&
                      ...
                      'webkitMovementX' !== e &&
                      'webkitMovementY' !== e &&
                      (('returnValue' === e && d.preventDefault) ||
                        (a[e] = d[e]))
                  if (
      ...
      88: [
        function (a, b, c) {
          ...
          function g(a) {
            return (
              !!a && 'object' === ('undefined' == typeof a ? 'undefined' : i(a))
            )
          }
          function h(a) {
            return (
        ...
        function (b, c, d) {
          ...
          function g(a, b, c) {
            ...
            g.hooks('beforesetup').forEach(function (a) {
              ...
              return !(0, V.isObject)(c) || Array.isArray(c)
                ? void g.log.error(
                    'please return an object in beforesetup hooks'
                  )
                : void (b = (0, B['default'])(b, c))
            })
          ...
          if (
            ('undefined' == typeof HTMLVideoElement &&
              j['default'].document &&
              j['default'].document.createElement &&
          ...
          n.autoSetupTimeout(1, g),
            ...
            'function' == typeof a && a.amd
              ...
              : 'object' === ('undefined' == typeof d ? 'undefined' : h(d)) &&
                'object' === ('undefined' == typeof c ? 'undefined' : h(c)) &&
                (c.exports = g),
            (d['default'] = g)
        },
        {
      ...
      99: [
        ...
        { 100: 100, 101: 101, 104: 104, 105: 105, 95: 95 }
      ],
      100: [
        function (a, b, c) {
          function d(a) {
